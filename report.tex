...
\section{Methodology}
    ...
    a simple method that can be used to simulate the system, but it is not very accurate as the order of eror is $delta t **2$. The Runge-Kutta
    ...
    specifically RK4\cite{Strogatz2000}.It strikes the perfect balance between computational time and minimizing errors but since this a family of RK higher orders may be used. In this project, RK4 was used to calculate the steps of angular velocity
